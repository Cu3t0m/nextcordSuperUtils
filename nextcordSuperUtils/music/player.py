...
class Player:
    ...
    def __init__(
        self,
        requester: Optional[nextcord.Member],
        used_query: str,
        title: str,
        stream_url: str,
        url: str,
    ...
    async def make_multiple_players(
        ...
        :type requester: Optional[nextcord.Member]
    ...
    @classmethod
    def create_player(
        cls, requester: nextcord.Member, query: str, player: dict
    ) -> Player:
        return cls(
            requester,
            query,
    ...
    async def make_players(
        ...
        :param YoutubeClient youtube: The youtube client.
        :param Optional[nextcord.Member] requester: The song requester.
        :param query: The query.
        :type query: str
        :param playlist: A bool indicating if the function should fetch playlists or get the first video.
        :type playlist: bool
