...
class MusicManager(DatabaseChecker):
    ...
    async def cleanup(
        self, voice_client: Optional[nextcord.VoiceClient], guild: nextcord.Guild
    ):
        """
        |coro|
        ...
        :param nextcord.Guild guild: The guild to cleanup.
        :param Optional[nextcord.VoiceClient] voice_client: The voice client.
        :return: None
        :rtype: None
        """
    ...
    async def add_playlist(
        self, user: nextcord.User, url: str
        ...
        :param nextcord.User user: The owner of the playlist.
    ...
    async def get_playlist(
        self, user: nextcord.User, playlist_id: str, partial: bool = False
    ) -> Optional[UserPlaylist]:
        """
        |coro|
        ...
        :param nextcord.User user: The user.
    ...
    async def get_user_playlists(
        self, user: nextcord.User, partial: bool = False
    ) -> List[UserPlaylist]:
        """
        |coro|
    ...
    async def create_playlist_players(
        self, playlist: Playlist, requester: nextcord.Member
    ) -> List[Player]:
        """
        |coro|
        ...
        :param nextcord.Member requester: The requester.
    ...
    async def create_player(
        self, query: str, requester: nextcord.Member
    ) -> List[Player]:
        """
        |coro|
        ...
        :type requester: nextcord.Member
    ...
    async def join(self, ctx: commands.Context) -> Optional[nextcord.VoiceChannel]:
        """
        |coro|
        ...
        :rtype: Optional[nextcord.VoiceChannel]
        """
        ...
        await channel.connect(
            cls=LavalinkPlayer
            if self.type == ManagerType.LAVALINK
            else nextcord.VoiceClient
        )
        return channel

    @ensure_connection()
    async def leave(self, ctx: commands.Context) -> Optional[nextcord.VoiceChannel]:
        """
        |coro|
