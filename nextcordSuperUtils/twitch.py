...
class TwitchManager(DatabaseChecker):
    ...
    async def add_channel(self, guild: nextcord.Guild, channel: str) -> None:
        """
        |coro|
    ...
    async def remove_channel(self, guild: nextcord.Guild, channel: str) -> None:
        """
        |coro|
    ...
    async def get_guild_channels(self, guild: nextcord.Guild) -> List[str]:
        """
        |coro|
