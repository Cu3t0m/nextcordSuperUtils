...
class LevelingManager(DatabaseChecker):
    ...
    async def set_interval(self, guild: nextcord.Guild, interval: int = None) -> None:
        """
    ...
    @DatabaseChecker.uses_database
    async def get_roles(self, guild: nextcord.Guild) -> List[int]:
        """
    ...
    @DatabaseChecker.uses_database
    async def set_roles(
        self, guild: nextcord.Guild, roles: Iterable[nextcord.Role]
    ) -> None:
        """
        ...
        :type roles: Iterable[nextcord.Role]
        :return:
        :rtype: None
        """
    ...
    @staticmethod
    def generate_checks(member: nextcord.Member):
    ...
    @DatabaseChecker.uses_database
    async def get_leaderboard(self, guild: nextcord.Guild):
        guild_info = sorted(
