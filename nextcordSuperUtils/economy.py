...
class EconomyManager(DatabaseChecker):
    ...
    async def create_account(self, member: nextcord.Member) -> None:
    ...
    async def get_account(self, member: nextcord.Member) -> Optional[EconomyAccount]:
        self._check_database()
    ...
    async def get_leaderboard(self, guild: nextcord.Guild) -> List[EconomyAccount]:
        guild_info = sorted(
